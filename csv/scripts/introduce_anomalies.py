...
SOURCE_PATH = os.getenv("DATA_PATH", "/app/generated_csv")
ANOMALIES_PATH = os.getenv("ANOMALIES_PATH", "/app/generated_csv_anomalies")

ENSEIGNANTS_FILE = os.path.join(SOURCE_PATH, "enseignants.csv")
DEPARTEMENTS_FILE = os.path.join(SOURCE_PATH, "departements.csv")
SALAIRES_FILE = os.path.join(SOURCE_PATH, "salaires.csv")
ABSENCES_FILE = os.path.join(SOURCE_PATH, "absences.csv")

ENSEIGNANTS_ANOMALIES = os.path.join(ANOMALIES_PATH, "enseignants_anomalies.csv")
DEPARTEMENTS_ANOMALIES = os.path.join(ANOMALIES_PATH, "departements_anomalies.csv")
SALAIRES_ANOMALIES = os.path.join(ANOMALIES_PATH, "salaires_anomalies.csv")
ABSENCES_ANOMALIES = os.path.join(ANOMALIES_PATH, "absences_anomalies.csv")
