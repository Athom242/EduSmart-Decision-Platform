...
DATA_PATH = os.getenv("DATA_PATH", "/app/generated_csv")

ENSEIGNANTS_FILE = os.path.join(DATA_PATH, "enseignants.csv")
DEPARTEMENTS_FILE = os.path.join(DATA_PATH, "departements.csv")
SALAIRES_FILE = os.path.join(DATA_PATH, "salaires.csv")
ABSENCES_FILE = os.path.join(DATA_PATH, "absences.csv")
